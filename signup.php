<h1 class="center">Зареєструватись на сайті</h1>
<div class="row">
    <form class="col s12" method="post">
        ...
        <div class="input-field col s12">
            <button type="button" id="signup-button" class="btn-large blue darken-2"><i class="material-icons left">task_alt</i>Реєстрація</button>
        </div>
    </form>
</div>